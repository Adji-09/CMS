                        ...
                        <table id="slideBanner" class="table table-bordered table-hover table-condensed table-striped display" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td id="td1">{{ ++$i }}</td>
                                    <td id="td1">
                                        <img src="{{ asset('slide_banner/'.$data->image) }}" alt="{{ $data->image }}" style="width: 100%; max-width: 150px; max-height: 100px;"/>
                                    </td>
                                    <?php
                                        if ($data->status==1) {
                                    ...
                                    ?>
                                    <td id="td3">
                                        <a id="editSlideBanner" title="Update Data" class="btn btn-success btn-sm" data-toggle="modal" data-target='#slideBannerEdit' data-id="{{ $data->id }}">
                                            <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                                        </a>
                                    </td>
                                    <td id="td3">
                                        <a id="deleteSlideBanner" title="Delete Data" class="btn btn-danger btn-sm deleteRecord" data-id="{{ $data->id }}">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ url('/slideBanner/store') }}" enctype="multipart/form-data">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="modal-edit">
                        <form method="POST" action="{{ url('/slideBanner/update') }}" enctype="multipart/form-data">
                            <input name="_token" type="hidden" value="{{ csrf_token() }}">
