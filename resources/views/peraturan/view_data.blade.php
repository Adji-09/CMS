                        ...
                        <table id="peraturan" class="table table-bordered table-hover table-condensed table-striped display" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    ?>
                                    <td id="td3">
                                        <a id="editPeraturan" title="Update Data" class="btn btn-success btn-sm" data-toggle="modal" data-target='#peraturanEdit' data-id="{{ $data->id }}">
                                            <span class="glyphicon glyphicon-edit" aria-hidden="true"></span>
                                        </a>
                                    </td>
                                    <td id="td3">
                                        <a id="deletePeraturan" title="Delete Data" class="btn btn-danger btn-sm deletePeraturan" data-id="{{ $data->id }}">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ url('/peraturan/store') }}" enctype="multipart/form-data">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="modal-edit">
                        <form method="POST" action="{{ url('/peraturan/update') }}" enctype="multipart/form-data">
                            <input name="_token" type="hidden" value="{{ csrf_token() }}">
